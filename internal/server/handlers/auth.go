...
func (a *AuthHandler) LoginHandler(w http.ResponseWriter, r *http.Request) {
	...
	sessionID, err := session.GenerateSessionID(a.cfg.SessionLength)
	if err != nil {
...
func (a *AuthHandler) LogoutHandler(w http.ResponseWriter, r *http.Request) {
	...
	if _, exists := a.sessions[sessionID]; !exists {
		...
		jsonutil.SendError(w, http.StatusNotFound, errs.ErrSessionNotExistsShort, errs.ErrSessionNotExists)
		return
	}
