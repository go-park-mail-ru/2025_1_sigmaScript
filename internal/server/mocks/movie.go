...
var ExistingMovies = Movies{
	1: {
		...
		Duration:        "2ч 19м",
		Genres: []GenreJSON{
			{ID: ExistingGenres["thriller"].ID, Name: ExistingGenres["thriller"].Name},
			{ID: ExistingGenres["drama"].ID, Name: ExistingGenres["drama"].Name},
		},
		Staff: []PersonJSON{
	...
	2: {
		...
		Duration:        "2ч 16м",
		Genres: []GenreJSON{
			{ID: ExistingGenres["fantastic"].ID, Name: ExistingGenres["fantastic"].Name},
			{ID: ExistingGenres["action movie"].ID, Name: ExistingGenres["action movie"].Name},
		},
		Staff: []PersonJSON{
